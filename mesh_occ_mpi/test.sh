...
export maxh=1000.0 
export minh=0.0
export input_path=/vol8/home/hnu_lhz/pwr/NETGEN/test_code_part01/inputData/$filename\.$fileformat
...
yhrun -p mt_module -N 12 -n 48 /vol8/home/hnu_lhz/pwr/NETGEN/test_code_part01/build/mesh_occ_mpi/mesh_occ_mpi -i $input_path -o $output_path -l $numlevels -r $numrefine --maxh $maxh --minh $minh -v -adj